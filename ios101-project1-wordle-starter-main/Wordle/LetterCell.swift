  ...
  func set(style: LetterCellStyle) {
    // START YOUR CODE HERE
      ...
      case .initial:
          ...
          layer.borderColor = UIColor.gray.cgColor
      case .incorrect:
          contentView.backgroundColor = .init(red: 0.23, green: 0.23, blue: 0.24, alpha: 1.0)
          layer.borderColor = .init(red: 0.23, green: 0.23, blue: 0.24, alpha: 1.0)
      case .correctLetterOnly:
          contentView.backgroundColor = .init(red:0.69, green: 0.63, blue: 0.30, alpha: 1.0)
          layer.borderColor = .init(red:0.69, green: 0.63, blue: 0.30, alpha: 1.0)
      case .correctLetterAndPosition:
          contentView.backgroundColor = .init(red:0.38, green: 0.55, blue: 0.33, alpha: 1.0)
          layer.borderColor = .init(red:0.38, green: 0.55, blue: 0.33, alpha: 1.0)
      }
    // END YOUR CODE HERE
  }
}
